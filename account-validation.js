...
class AccountFormValidator {
    ...
    setupPhoneFormatting() {
        ...
        phoneInput.addEventListener('input', (e) => {
            ...
            // Remove existing +233 or 233 to prevent duplication
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.selectAccountType = (accountType) => window.accountValidator.selectAccountType(accountType);
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        window.accountValidator.nextStep(5);
                    }, 1000);
                }, 2000);
            }, 3000);
        }, 2000);
